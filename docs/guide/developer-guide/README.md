...
2. Clone the GitHub repository: `git clone https://github.com/Homital/Homital-App.git`
3. Open HBuilderX IDE and import this project. Note that there are two ways to import this project into HBuilderX IDE:
...
4. To build the project as an Android or iOS app, go to `发行(U)`(Release) -> `原生App-云打包`(Native App-Cloud Build) and edit the options as following:

![HBuilderX Build Android](../assets/hbx_android.png)
![HBuilderX Build iOS](../assets/hbx_ios.png)

5. After that, the console at the bottom will output the download links to the built packages.
